                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    ...
                                    <?php else: ?>
                                        <img class="img-profile rounded-circle" src="<?= base_url() ?>uploads/<?= $this->session->userdata('company_name')?>/user/<?= $this->session->userdata('profile_picture') ?>">
                                    <?php endif; ?>
                                </a>
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Sistem Informasi Pertokoan 2020</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
